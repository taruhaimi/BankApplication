                ...
                for (int i = 0; i < MainActivity.accountArrayList().size(); i++) {
                    ...
                    if (MainActivity.accountArrayList().get(i).cardArrayList.contains(allCards.get(index))) {
                        ...
                        if (allCards.get(index).getContactlessPay().equals("No") && pin.equals("")) {
                            ...
                            MainActivity.accountArrayList().get(i).createTransaction(MainActivity.accountArrayList().get(i).getID(), "Simulation", money, "Card Payment");
                            ...
                            withdrawCheck = MainActivity.accountArrayList().get(i).getMoney() - money; // checks how much the account would go below 0 and saves it to withdrawCheck
                            if (withdrawCheck < 0 && allCards.get(index).getType().equals("Credit")) {
                                // this if-else checks if account + cards credit is enough to pay the payment.
